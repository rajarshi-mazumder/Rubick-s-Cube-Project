...
public class ReadCube : MonoBehaviour
{
    ...
    List<GameObject> BuildRays(Transform rayTransform, Vector3 direction)
    {
        ...
        // This creates rays in the shape of the side of the cube 
        // For 3x3 cube, Ray 0 at the top left and Ray 8 at the bottom right:
    ...
    public void SetInitializemap() // initialize colors of the cubemap to the colors of the little cubes
    {                              // this must is called before the first check of state of the cube is done
    ...
    IEnumerator Initializemap()
    {
        ...
        ReadState();
        this.GetComponent<CubeManager>().cur_state = CubeManager.States.Default;
    }
}
